                        ...
                        <div class="tab-content">
                            <div class="row">
                                ...
                                <div class="col-sm-12" style="min-height: 100px;margin-top: 30px;">
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td>
                                                <span class="label-q">Minimum luas gedung adalah 2500 m2</span>
                                            </td>
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td>
                                                <span class="label-q">Kesediaan data gedung untuk diakses GBC Indonesia terkait proses sertifikasi</span>
                                            </td>
                                            <td style="text-align: center;">
                                                <div class="checkbox" style="margin: 0px;">
                                                    <label>
                                        ...
                                        <tr>
                                            <td>3</td>
                                            <td>
                                                <span class="label-q">Fungsi gedung sesuai dengan peruntukan lahan berdasarkan RTRWsetempat</span>
                                            </td>
                                            <td style="text-align: center;">
                                                <div class="checkbox" style="margin: 0px;">
                                                    <label>
                                        ...
                                        <tr>
                                            <td>4</td>
                                            <td>
                                                <span class="label-q">Kepemilikan AMDAL dan/atau rencana Upaya Pengelolaan Lingkungan (UKL)/Upaya Pemantauan Lingkungan (UPL)</span>
                                            </td>
                                            <td style="text-align: center;">
                                                <div class="checkbox" style="margin: 0px;">
                                                    <label>
                                        ...
                                        <tr>
                                            <td>5</td>
                                            <td>
                                                <span class="label-q">Kesesuaian gedung terhadap standar keselamatan untuk kebakaran</span>
                                            </td>
                                            <td style="text-align: center;">
                                                <div class="checkbox" style="margin: 0px;">
                                                    <label>
                                        ...
                                        <tr>
                                            <td>6</td>
                                            <td>
                                                <span class="label-q">Kesesuaian gedung terhadap standar ketahanan gempa</span>
                                            </td>
                                            <td style="text-align: center;">
                                                <div class="checkbox" style="margin: 0px;">
                                                    <label>
                                        ...
                                        <tr>
                                            <td>7</td>
                                            <td>
                                                <span class="label-q">Kesesuaian gedung terhadap standar aksesibilitas difabel</span>
                                            </td>
                                            <td style="text-align: center;">
                                                <div class="checkbox" style="margin: 0px;">
                                                    <label>
                                ...
                                <div class="col-md-12 text-right">
                                    <hr/>
                                    <button class='btn btn-fill btn-danger'>Next</button>
                                </div>
                            </div>
